CREATE TABLE [dbo].[TextResponseDetails] (
    ...
    CONSTRAINT [PK_TextResponseDetails] PRIMARY KEY CLUSTERED ([TextResponseDetailsID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON),
...
CREATE NONCLUSTERED INDEX [IX_TextResponseDetails_TextResponseID]
    ...
    INCLUDE([From], [To], [SenderID], [Message], [Status], [ServiceResponse]) WITH (FILLFACTOR = 90, PAD_INDEX = ON);
