...
BEGIN
	...
	BEGIN
		SELECT  C.ContactID as contactID, '' as firstname, '' as lastname, '' as email, '' as phonenumber, 0 AS ContactEmailID
	...
	BEGIN
		...
		WHERE C.AccountID = @AccountID AND C.IsDeleted = 0 AND C.IncludeInReports=1 AND CCM.IsDeleted = 0) x
		UNION
