...
INNER JOIN dbo.CampaignRecipients cr (nolock) ON c.CampaignID = cr.CampaignID
LEFT JOIN dbo.CampaignStatistics cs (nolock) ON cr.CampaignRecipientID = cs.CampaignRecipientID						    
