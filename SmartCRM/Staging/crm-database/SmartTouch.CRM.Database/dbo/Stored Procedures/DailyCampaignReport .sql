...
DECLARE @CampaignReport TABLE (AccountName NVARCHAR(100),CampaignId INT, CampaignSubject nvarchar(200),[ServiceProvider] varchar(50), Recipients INT ,[Sent] INT ,Delivered INT ,Bounced INT ,Opened INT ,Clicked INT,Complained INT ,TagsAll INT,TagsActive INT ,SavedSearchAll INT ,SavedSearchActive INT,SentDate DATETIME)
...
SELECT Datavalue  From dbo.Split (@AccountIdS ,',')
		...
		INSERT INTO @CampaignReport (AccountName,CampaignId,CampaignSubject,[ServiceProvider], Recipients,[Sent],Delivered,Bounced,Opened,Clicked,Complained, TagsAll,TagsActive,SavedSearchAll,SavedSearchActive,SentDate)
		...
		INSERT INTO  #dailyCampaignReport (CampaignId ,AccountName , CampaignSubject ,[Vmta] , Recipients  ,[Sent]  ,Delivered  ,Bounced  ,Opened   ,Clicked  ,Complained  ,TagsAll,TagsActive ,SavedSearchAll ,SavedSearchActive,SentDate)
...
SELECT * FROM #dailyCampaignReport ORDER BY  AccountName
...
WHILE @counter < 3
	BEGIN
		...
		INSERT INTO  #dailyCampaignReport (CampaignId,Day ,AccountName , CampaignSubject ,[VMTA] , Recipients  ,[Sent]  ,Delivered  ,Bounced  ,Opened   ,Clicked  ,Complained  ,TagsAll,TagsActive ,SavedSearchAll ,SavedSearchActive,SentDate)
