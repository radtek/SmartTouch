...
BEGIN
	BEGIN TRY
			...
			--ContactCommunityMap insertion and updation started.
					...
					select @contactId,CommunityID,GETUTCDATE(),CreatedBy,LastModifiedOn,LastModifiedBy,IsDeleted from @contactCommunityMap where ContactCommunityMapID is null or ContactCommunityMapID = 0  AND CommunityID > 0;
