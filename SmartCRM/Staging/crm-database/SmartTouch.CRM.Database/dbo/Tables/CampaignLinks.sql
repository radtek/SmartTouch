CREATE TABLE [dbo].[CampaignLinks] (
    ...
    CONSTRAINT [PK_CampaignLinks] PRIMARY KEY CLUSTERED ([CampaignLinkID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON),
...
CREATE NONCLUSTERED INDEX [IX_CampaignLinks_CampaignID_Name]
    ...
    INCLUDE([CampaignLinkID], [URL], [LinkIndex], [Name]) WITH (FILLFACTOR = 90, PAD_INDEX = ON);
