CREATE TABLE [dbo].[ContactAddressMap] (
    ...
    [ContactID]           INT NULL,
    [AddressID]           INT NULL,
    CONSTRAINT [PK_ContactAddressMap] PRIMARY KEY CLUSTERED ([ContactAddressMapID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON),
...
CREATE NONCLUSTERED INDEX [IX_ContactAddressMap_AddressID]
    ...
    INCLUDE([ContactAddressMapID], [ContactID]) WITH (FILLFACTOR = 90, PAD_INDEX = ON);
