CREATE TABLE [dbo].[CampaignRecipients_0005] (
    ...
    CONSTRAINT [UNIQUE_CampaignRecipients_0005_CampaignRecipientID_CampaignID] UNIQUE NONCLUSTERED ([CampaignRecipientID] ASC, [CampaignID] ASC) WITH (FILLFACTOR = 90) ON [SecondaryFG]
);
