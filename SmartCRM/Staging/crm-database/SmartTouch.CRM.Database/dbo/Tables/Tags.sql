CREATE TABLE [dbo].[Tags] (
    ...
    [Count]       INT            NULL,
    CONSTRAINT [PK_Tags] PRIMARY KEY CLUSTERED ([TagID] ASC) WITH (FILLFACTOR = 90)
);
...
GO
CREATE TRIGGER [dbo].[tr_Tags_Insert] ON dbo.Tags FOR INSERT AS

INSERT INTO Tags_Audit(TagID,TagName,Description,Count,[AccountID],IsDeleted, AuditAction,AuditStatus) 
