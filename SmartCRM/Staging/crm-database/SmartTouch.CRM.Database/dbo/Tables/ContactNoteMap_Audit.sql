CREATE TABLE [dbo].[ContactNoteMap_Audit] (
    ...
    CONSTRAINT [PK_ContactNoteMap_Audit] PRIMARY KEY CLUSTERED ([AuditId] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON)
);


GO
CREATE NONCLUSTERED INDEX [IX_ContactNoteMap_Audit_ContactID]
    ON [dbo].[ContactNoteMap_Audit]([ContactID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON);
