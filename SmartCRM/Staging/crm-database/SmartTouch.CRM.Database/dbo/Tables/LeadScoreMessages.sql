CREATE TABLE [dbo].[LeadScoreMessages] (
    ...
    CONSTRAINT [PK_LeadScoreMessages] PRIMARY KEY CLUSTERED ([LeadScoreMessageID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON),
...
CREATE NONCLUSTERED INDEX [IX_LeadScoreMessages_LeadScoreProcessStatusID]
    ON [dbo].[LeadScoreMessages]([LeadScoreProcessStatusID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON);
