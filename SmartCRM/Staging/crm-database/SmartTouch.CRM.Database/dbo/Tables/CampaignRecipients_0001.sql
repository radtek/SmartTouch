CREATE TABLE [dbo].[CampaignRecipients_0001] (
    ...
    CONSTRAINT [PK_CampaignRecipients_0001] PRIMARY KEY CLUSTERED ([CampaignRecipientID] ASC, [CampaignID] ASC) WITH (FILLFACTOR = 90, PAD_INDEX = ON) ON [SecondaryFG],
...
GO
CREATE STATISTICS [_dta_stat_834154067_9_1]
    ON [dbo].[CampaignRecipients_0001]([DeliveredOn], [CampaignRecipientID]);
