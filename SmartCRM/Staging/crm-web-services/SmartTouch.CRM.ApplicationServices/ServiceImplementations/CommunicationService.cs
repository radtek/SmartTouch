    ...
    public class CommunicationService : ICommunicationService
    {
        ...
        public SendTextResponse SendText(SendTextRequest request)
        {
            ...
            if (sendTextViewModel.ServiceProvider != null)
            {
                ...
                List<ContactOwnerPhone> ownerNumbers = contactRepository.GetContactOwerPhoneNubers(contactids);
                if (ownerNumbers.IsAny())
                {
                    ownerNumbers.Each(n =>
                    {
                        ...
                        {
                            if (n.ContactID == c)
                                n.ContactNumber = sendTextViewModel.Contacts.Where(p => (int)p.ContactID == c).Select(s => (string)s.Phone).FirstOrDefault();
                ...
                else
                {
                    ...
                    {
                        InsertTextMessageAuditData(sendTextRequest, varsentTextresponse, sendTextViewModel, contactids);
                    }
