...
namespace SmartTouch.CRM.ApplicationServices.ServiceInterfaces
{
    public interface ICampaignService
    {
        ...
        void ReScheduleCampaign(int campaignId, DateTime scheduleDate);
        void ReScheduleAutomationCampaign(int campaignId, DateTime scheduleDate);
        ...
        void UpdateCampaignSentFlagStatus(Int32 _campaignId, bool _mailsentflag); //NEXG-3005 , NEXG-3004 and NEXG-3007
        List<CampaignRecipient> GetSSearchContactslist(GetSearchRequest request, Campaign _campaign); //NEXG-3005 , NEXG-3004 and NEXG-3007
    }
}
