...
namespace SmartTouch.CRM.ApplicationServices.ServiceInterfaces
{
    public interface ITourService
    {
        ...
        Tour UpdateTourBulkData(int tourId, int accountId, int userId, string accountPrimaryEmail, string accountDomain, bool icsCalender,string AccountAddress,IEnumerable<int> contactIDs,bool contactMode,int ownerID,IDictionary<int,Guid> emailGuids, IDictionary<int, Guid> textGuids);
    }
}
