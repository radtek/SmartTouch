...
namespace SmartTouch.CRM.ApplicationServices.Messaging.Communication
{
    ...
    {
        public CommunicationStatus ResponseMessage { get; set; }    //Need to rename this to ResponseStatus
        public string ResponseDescription { get; set; }             //Need to rename this to ResponseMessage
        public SendMailViewModel SendMailViewModel { get; set; }        
    }
}
