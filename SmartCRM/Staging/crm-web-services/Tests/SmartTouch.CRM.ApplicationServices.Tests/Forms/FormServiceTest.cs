...
namespace SmartTouch.CRM.ApplicationServices.Tests.Forms
{
    ...
    public class FormServiceTest
    {
        ...
        Mock<IServiceProviderRepository> serviceProviderRepository;//NEXG-3014
        Mock<IFindSpamService> findSapmService; //NEXG-3014
        ...
        public void Initialize()
        {
            ...
            serviceProviderRepository = mockRepository.Create<IServiceProviderRepository>(); //NEXG-3014
            findSapmService = mockRepository.Create<IFindSpamService>();
            ...
            formService = new FormService(
                 ...
                 , serviceProviderRepository.Object //NEXG-3014                 
                 , findSapmService.Object //NEXG-3014
                 );
        }
