...
namespace SmartTouch.CRM.SearchEngine.Search
{
    internal class SearchBase<T> where T : class
    {
        ...
        public SearchBase(int accountId)
        {
            ...
            // indices.Add(typeof(Opportunity), "opportunities");  commented by Ram on 2nd May 2018 CR NEXG-3001
            // indices.Add(typeof(Campaign), "campaigns" + this.accountId);  commented by Ram on 2nd May 2018 CR NEXG-3001
        ...
        SearchResult<Suggestion> convertToSuggestions(IEnumerable<object> quickSearchResults, SearchParameters parameters)
        {
            ...
            foreach (object result in quickSearchResults)
            {
                ...
                //commented by Ram on 2nd May 2018 CR NEXG-3001
                ...
                //}  commented by Ram on 2nd May 2018 CR NEXG-3001 -------End-------------
