...
namespace SmartTouch.CRM.Domain.ImportData
{
    ...
    {
        int InsertLeadAdapterjob(LeadAdapterJobLogs leadAdapterJobLog,Guid uniqueidentifier,bool updateOnDuplicate,bool isFromImport,int AccountID, int UserID, int DuplicteLogicID,int ownerId, bool IncludeInReports);
