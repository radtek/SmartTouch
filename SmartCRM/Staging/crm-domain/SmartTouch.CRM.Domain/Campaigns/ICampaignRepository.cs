...
namespace SmartTouch.CRM.Domain.Campaigns
{
    public interface ICampaignRepository : IRepository<Campaign, int>
    {
        ...
        void InsertCampaignRecipients(Campaign _campaign, CampaignRecipient _campRecp);  // Added by Ram on 9th May 2018  for Ticket NEXG-3005, NEXG-3004 and NEXG-3007
