...
namespace SmartTouch.CRM.ImportLeadProcessor
{
    ...
    {
        public const string NameOfService = "Smart CRM - Import Lead Processor";
        ...
        {
            RegisterJob<ImportLeadJob>(CronJobType.ImportLeadProcessor);
            RegisterJob<NeverBounceFileJob>(CronJobType.NeverBounceFileProcessor);
            RegisterJob<NeverBouncePollingJob>(CronJobType.NeverBouncePollingProcessor);
            RegisterJob<NeverBounceResultsJob>(CronJobType.NeverBounceResultsProcessor);
        }
    }
}
