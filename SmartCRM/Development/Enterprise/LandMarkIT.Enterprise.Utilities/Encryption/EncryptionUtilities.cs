...
namespace LandmarkIT.Enterprise.Utilities.Encryption
{
    public static class EncryptionUtilities
    {
        /*
         * Same methods are available in SQL CLR. If any change to these methods. Please change in SQL CLR also.
         * */
