...
namespace LandmarkIT.Enterprise.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Convert to User time with based on user timezone
        /// </summary>
        /// <param name="d"></param>
        /// <returns></returns>
        public static DateTime ToUserUtcDateTimeV3(this DateTime d)
        {
            d = d.AddMinutes(-1 * GetUtzOffset().TotalMinutes).ToUtc();
            return d;
        }
        /// <summary>
