CREATE TABLE [dbo].[ContactEmailAudit] (
    ...
    CONSTRAINT [PK__ContactEmailAudit] PRIMARY KEY CLUSTERED ([ContactEmailAuditID] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [FK_ContactEmailAudit_ContactEmails] FOREIGN KEY ([ContactEmailID]) REFERENCES [dbo].[ContactEmails] ([ContactEmailID]),
...
CREATE NONCLUSTERED INDEX [IX_ContactEmailAudit_ContactEmailID_Status]
    ...
    INCLUDE([SentBy], [SentOn], [RequestGuid]) WITH (FILLFACTOR = 90);
