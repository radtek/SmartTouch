...
BEGIN
	SET NOCOUNT ON
		...
		select CONVERT(VARCHAR(20),MAX(cr.SentOn)) Data, 'Campaign Sent' Module, a.AccountName AccountName, camp.AccountID AccountID from vCampaignRecipients cr (NOLOCK)
