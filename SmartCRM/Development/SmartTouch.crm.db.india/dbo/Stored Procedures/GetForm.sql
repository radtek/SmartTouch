 ...
 CREATE PROCEDURE [dbo].[GetForm]
       ...
       BEGIN
		...
		SELECT FormID, Name, Acknowledgement, AcknowledgementType, HTMLContent, [Status], AccountID, CreatedBy, CreatedOn, LastModifiedBy, LastModifiedOn, IsDeleted, Submissions, 
		LeadSourceID, @AllSubmissions AllSubmissions, @UniqueSubmissions UniqueSubmissions FROM Forms (NOLOCK) WHERE FormID = @FormID
