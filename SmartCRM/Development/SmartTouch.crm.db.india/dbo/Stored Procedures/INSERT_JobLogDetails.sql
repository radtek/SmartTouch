...
BEGIN
	...
	BEGIN TRANSACTION
		...
		INSERT INTO [dbo].[LeadAdapterJobLogs] (LeadAdapterAndAccountMapID, StartDate, EndDate, LeadAdapterJobStatusID, [FileName], CreatedBy, CreatedDateTime)
		SELECT @leadAdapterAndAccountMapID, GETUTCDATE(), GETUTCDATE(), 4, @filename, @UserID, GETUTCDATE()
