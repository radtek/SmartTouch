...
namespace SmartTouch.CRM.Web.Controllers
{
    ...
    public class ContactController : SmartTouchController
    {
        ...
        public ActionResult _AddTour()
        {
            ...
            tourViewModel.LifeCycleStages = GetFromDropdownValues(dropdownValues, (byte)DropdownFieldTypes.LifeCycle);
            ...
            tourViewModel.LifeCycleStage = null;
        ...
        [HttpPost]
        public JsonResult GetLifeCycleStageForTour(string contactIds)
        {
            int[] ContactIDs = JsonConvert.DeserializeObject<int[]>(contactIds);
            GetLifeCycleStageofTourResponse response = tourService.GetLifeCycleStageofTour(new GetLifeCycleStageofTourRequest() { AccountId = this.Identity.ToAccountID(), ContactIds = ContactIDs });
            return Json(new
            {
                success = true,
                response = response.LifeCycleStage
            }, JsonRequestBehavior.AllowGet);
        }
