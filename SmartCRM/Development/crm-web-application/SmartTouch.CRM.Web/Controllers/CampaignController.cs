    ...
    public class CampaignController : SmartTouchController
    {
        ...
        public ActionResult ResendNewCampaign(string viewmodel)
        {
            ...
            if (!string.IsNullOrEmpty(viewModel.HTMLContent))
            {
                ...
                Logger.Current.Informational("Special Characters Replaced HTML Content: " + viewModel.HTMLContent);
            }
        ...
        public ActionResult EditCampaign(int campaignId)
        {
            ...
            //added by kiran on 01/06/2018 NEXG-3005
            if (response.CampaignViewModel.CampaignStatus == CampaignStatus.Failure)
                response.CampaignViewModel.IsRecipientsProcessed = false;
            //End
        ...
        public JsonResult SendTestEmail(string sendMailViewModel, int? serviceProviderId, bool hasDisCliamer)
        {
            ...
            {
                viewModel.Body = viewModel.Body.CharactersToHtmlCodes();
            }
        ...
        [HttpPost]
        public ActionResult DownloadHtml(string contentType, string base64, string fileName)
        {
