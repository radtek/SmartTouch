                    ...
                    if (customFieldIndex != -1 && (field.Value() == "" || field.Value() == null)) {
                        ...
                        if (field.FieldInputTypeId() == DATATYPE_CHECKBOX || field.FieldInputTypeId() == DATATYPE_MULTISELECT) {
                            ...
                            selfContact.CustomFields.push({
                                ...
                                ContactId: selfContact.ContactID,
                                CustomFieldId: field.FieldId(),
                                Value: kendo.toString(selfContact.CustomFieldTabs()[index].Sections()[sectionIndex].CustomFields()[fieldIndex].Value(), readCookie("dateformat")),
                                FieldInputTypeId: field.FieldInputTypeId()
                            })
                            field.Value(kendo.toString(selfContact.CustomFieldTabs()[index].Sections()[sectionIndex].CustomFields()[fieldIndex].Value(), readCookie("dateformat")));
                        ...
                        if (field.FieldInputTypeId() == DATATYPE_DATE) {
                            selfContact.CustomFields()[customFieldIndex].Value = kendo.toString(selfContact.CustomFieldTabs()[index].Sections()[sectionIndex].CustomFields()[fieldIndex].Value(), readCookie("dateformat"));
