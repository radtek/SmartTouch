var ImportDataViewModel = function (data, url, Users, neverBouncePermission) {
    ...
    selfImportdata.LeadSources = ko.observableArray();
    ...
    selfImportdata.LeadSourceId = ko.observable();
    $.ajax({
        url: '/getleadsources',
        type: 'get',
        dataType: 'json',
        ...
        selfImportdata.LeadSources(data.response);
    ...
    selfImportdata.LeadSourceId(data.LeadSourceId);
    ...
    selfImportdata.saveImportdata = function () {
        ...
        if (continuetosave) {
            $("#LSModal").modal('toggle');

            if(selfImportdata.LeadSourceId())
                $("#LSOK").attr('disabled', false);
            else
                $("#LSOK").attr('disabled', true);
        }

    };

    selfImportdata.LSConfirm = function () {
    ...
    selfImportdata.LSCancel = function () {
        $("#LSModal").modal('toggle');
    }
