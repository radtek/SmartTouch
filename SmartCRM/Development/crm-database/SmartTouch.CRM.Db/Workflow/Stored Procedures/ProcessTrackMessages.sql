...
BEGIN
	...
	AS(
		...
		COALESCE(Campaignid, Formid, Lifecycledropdownvalueid, TagID, Searchdefinitionid, OpportunitystageID, Leadadapterid, LeadScore, Duration, ActionType) as Entityid,
		CASE
