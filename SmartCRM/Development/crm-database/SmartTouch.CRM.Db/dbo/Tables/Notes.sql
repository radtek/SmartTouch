...
CREATE TABLE [dbo].[Notes](
	...
	CONSTRAINT [PK_Notes] PRIMARY KEY nonCLUSTERED ([NoteID] ASC) WITH (FILLFACTOR = 90),
...
Create NonClustered Index IX_Notes_missing_185 On [dbo].[Notes] ( [AccountID] ,[CreatedBy], [AddToContactSummary]) Include ([NoteID], [NoteDetails], [CreatedOn], [NoteCategory]) ON [AccountId_Scheme_UserActivityLogs]([AccountID]) 
GO
