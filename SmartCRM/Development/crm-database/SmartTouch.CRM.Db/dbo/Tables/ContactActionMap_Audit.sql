CREATE TABLE [dbo].[ContactActionMap_Audit] (
    ...
    CONSTRAINT [PK_ContactActionMap_Audit] PRIMARY KEY CLUSTERED ([AuditId] ASC) WITH (FILLFACTOR = 90) ON [SECONDARY]
);
...
CREATE NONCLUSTERED INDEX [IX_ContactActionMap_Audit_ContactID_AuditAction]
    ON [dbo].[ContactActionMap_Audit]([ContactID] ASC, [AuditAction] ASC) WITH (FILLFACTOR = 90)
    ON [SECONDARY];
