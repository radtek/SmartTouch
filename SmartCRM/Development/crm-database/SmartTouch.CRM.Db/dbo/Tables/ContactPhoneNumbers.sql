CREATE TABLE [dbo].[ContactPhoneNumbers] (
    ...
    CONSTRAINT [PK_ContactPhoneNumbers] PRIMARY KEY CLUSTERED ([ContactPhoneNumberID] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [IX_ContactPhoneNumbers_ContactID]
    ...
    INCLUDE([ContactPhoneNumberID], [PhoneNumber], [PhoneType], [IsPrimary], [AccountID]) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_ContactPhoneNumbers_ContactID_ContactID]
    ON [dbo].[ContactPhoneNumbers]([ContactID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_ContactPhoneNumbers_IsDeleted]
    ON [dbo].[ContactPhoneNumbers]([IsDeleted] ASC)
    INCLUDE([ContactPhoneNumberID], [ContactID], [PhoneNumber], [AccountID]) WITH (FILLFACTOR = 90);
...
CREATE NONCLUSTERED INDEX [IX_ContactPhoneNumbers_IsPrimary_IsDeleted]
    ...
    INCLUDE([ContactPhoneNumberID], [ContactID], [PhoneNumber], [PhoneType], [AccountID]) WITH (FILLFACTOR = 90);
