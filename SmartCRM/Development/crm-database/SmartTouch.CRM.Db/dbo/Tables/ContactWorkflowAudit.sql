CREATE TABLE [dbo].[ContactWorkflowAudit] (
    ...
    CONSTRAINT [PK_ContactWorkflowAudit] PRIMARY KEY CLUSTERED ([ContactWorkflowAuditID] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [IX_ContactWorkflowAudit_ContactID]
    ON [dbo].[ContactWorkflowAudit]([ContactID] ASC)
    INCLUDE([ContactWorkflowAuditID], [WorkflowID], [WorkflowActionID], [ActionPerformedOn]) WITH (FILLFACTOR = 90);


GO

CREATE NONCLUSTERED INDEX [IX_ContactWorkflowAudit_ContactID_WorkflowID_WorkflowActionID]
    ON [dbo].[ContactWorkflowAudit]([ContactID] ASC, [WorkflowID] ASC, [WorkflowActionID] ASC) WITH (FILLFACTOR = 90);
...
CREATE NONCLUSTERED INDEX [IX_ContactWorkflowAudit_WorkflowID_ContactWorkflowAuditID]
    ON [dbo].[ContactWorkflowAudit]([WorkflowID] ASC)
    INCLUDE([ContactWorkflowAuditID], [ContactID], [WorkflowActionID], [ActionPerformedOn]) WITH (FILLFACTOR = 90);
