CREATE TABLE [dbo].[Actions_Audit] (
    ...
    CONSTRAINT [PK_Actions_Audit] PRIMARY KEY CLUSTERED ([AuditId] ASC) WITH (FILLFACTOR = 90) ON [SECONDARY]
);
...
CREATE NONCLUSTERED INDEX [IX_Actions_Audit_ActionID_ActionDetails_CreatedBy]
    ...
    INCLUDE([ActionDetails], [CreatedBy], [AuditAction], [AuditDate], [AuditStatus]) WITH (FILLFACTOR = 90)
    ON [PRIMARY];
