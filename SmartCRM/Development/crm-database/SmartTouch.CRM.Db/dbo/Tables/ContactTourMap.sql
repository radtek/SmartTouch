CREATE TABLE [dbo].[ContactTourMap] (
    ...
    CONSTRAINT [PK_ContactTourMap] PRIMARY KEY CLUSTERED ([ContactTourMapID] ASC) WITH (FILLFACTOR = 90) ON [SECONDARY],
...
CREATE NONCLUSTERED INDEX [IX_ContactTourMap_ContactID]
    ON [dbo].[ContactTourMap]([ContactID] ASC) WITH (FILLFACTOR = 90)
    ON [SECONDARY];
...
GO
CREATE NONCLUSTERED INDEX [IX_ContactTourMap_TourID_TourID]
    ON [dbo].[ContactTourMap]([TourID] ASC) WITH (FILLFACTOR = 90)
    ON [SECONDARY];
