...
BEGIN 
	...
	SET NOCOUNT ON
		...
		BEGIN TRY			
				...
				SELECT @SubscriptionID = SubscriptionID, @AccountName = AccountName, @UserID = CreatedBy, @HelpURL = HelpURL, @UserLimit = UserLimit  FROM @AccountInfo			
				...
				BEGIN
				  ...
				  SELECT SubscriptionID, ModuleID,@AccountID, @UserLimit
