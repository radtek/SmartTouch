CREATE TABLE [dbo].[MailRegistration] (
    ...
    CONSTRAINT [PK_MailRegistration] PRIMARY KEY CLUSTERED ([MailRegistrationID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IX_MailRegistration_Guid]
    ...
    INCLUDE([Name], [Host], [APIKey], [UserName], [Password], [Port], [IsSSLEnabled], [MailProviderID], [VMTA], [SenderDomain]);
