...
namespace SmartTouch.CRM.Domain.Contacts
{
    public interface IContactRepository : IRepository<Contact, int>
    {
        ...
        IDictionary<int,int> GetContactByPhoneNumberID(IEnumerable<int> ContactPhoneNumberIDs);
        ...
        */
        ...
        IEnumerable<int> GetUntouchedContactsIds(int accountId, int userId,DateTime startDate,DateTime endDate);
        void InsertBulkConactsData(IEnumerable<BulkContact> conactsData);
    }
}
