...
{
    public class CondoLeadAdapterProvider : BaseLeadAdapterProvider
    {
        ...
        public override ImportContactsData GetContacts(string fileName, IEnumerable<FieldViewModel> customFields, int jobId, IEnumerable<DropdownValueViewModel> DropdownFields)
        {
            ...
            try
            {
                ...
                customFields = customFields.Where(i => i.IsLeadAdapterField && i.LeadAdapterType == (byte)LeadAdapterTypes.Condo && i.StatusId == FieldStatus.Active);
                ...
                foreach (var lead in leads)
                {
                    ...
                    if (!IsNotValidContact && builderNumberPass && communityNumberPass)
                    {
                        ...
                        else if (string.IsNullOrEmpty(PrimaryEmail) && hashes.Where(h => h.Contains(hash.ToString())).Count() > 0)
                            isDuplicateFromFile = true;
                        else
                            isDuplicateFromFile = false;
                    }
                        ...
                        foreach (var attribute in allattributes)
                        {
                            ...
                            try
                            {
                                ...
                                else if (attribute.LocalName.ToLower() == "phone")
                                {
                                    ...
                                    if (drpvalue != null && !string.IsNullOrEmpty(attribute.Value))
                                    {                                       
                                ...
                                {
                                    var customField = customFields.Where(i => i.Title.Replace(" ", string.Empty).ToLower() == (attribute.LocalName.ToLower() + "(" + LeadAdapterTypes.Condo.ToString().ToLower() + ")")).FirstOrDefault();
                                    if (customField != null)
                                    {
                            ...
                            {
                                Logger.Current.Error("An exception occured in Genereating old new values attribute in CondoLeadAdapter : " + attribute.LocalName, ex);
                                continue;
                            }
                        }
                    }
                    ...
                    {
                        Logger.Current.Error("An exception occured in Genereating old new values attribute in CondoLeadAdapter : ", ex);
                    }
        ...
        //    mappings.Add("LeadID", "LeadID");
        //    mappings.Add("FirstName", "FirstName");
        //    mappings.Add("LastName", "LastName");
        //    mappings.Add("Email", "Email");
        //    mappings.Add("Phone", "Phone");
        //    mappings.Add("StreetAddress", "StreetAddress");
        //    mappings.Add("City", "City");
        //    mappings.Add("State", "State");
        //    mappings.Add("PostalCode", "PostalCode");
        //    mappings.Add("ReasonsForBuying", "ReasonsForBuying");
        //    mappings.Add("MoveInDate", "MoveInDate");
        //    mappings.Add("Comments", "Comments");
        //    mappings.Add("DateCreated", "DateCreated");
        ...
        //    mappings.Add("PlanName", "PlanName");
        //    mappings.Add("PlanNumber", "PlanNumber");
        //    mappings.Add("Address", "Address");
        //    mappings.Add("LeadMessage", "LeadMessage");
        //    mappings.Add("CountElements", "CountElements");
        //    mappings.Add("LeadDetails", "LeadDetails");
        //    mappings.Add("ZipCode", "ZipCode");
        //    mappings.Add("PriceMin", "PriceMin");
        //    mappings.Add("PriceMax", "PriceMax");
        //    mappings.Add("Bedrooms", "Bedrooms");
        //    mappings.Add("Bathrooms", "Bathrooms");
        //    return mappings;
        //}
