...
{
    public class NightlyScheduledDeliverabilityReportProcessor: IJob
    {
        ...
        public static void Trigger(Object stateInfo)
        {
            try
            {
              if (isRunning) return;
                ...
                NightlyScheduledDeliverabilityReport nightlyReport = contactRepository.GetSenderRecipientInfoNightlyReport();
                IEnumerable<CampaignSenderRecipientNightlyReport> campaignReport = contactRepository.GetCampaignSenderRecipientInfoNightlyReport();
                ...
                string attachmentPath = System.Configuration.ConfigurationManager.AppSettings["NIGHTLYREPORT_PHYSICAL_PATH"].ToString();
                string toEmail = System.Configuration.ConfigurationManager.AppSettings["NIGHTLY_REPORTED_EMAILS"].ToString();
                string fromEmail = System.Configuration.ConfigurationManager.AppSettings["SUPPORT_EMAILID"].ToString();
