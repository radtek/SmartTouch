...
namespace SmartTouch.CRM.WebService.Controllers
{
    ...
    public class AccountsController : SmartTouchApiController
    {
        ...
        /// <param name="pushNotificationService">pushNotificationService</param>
        public AccountsController(IAccountService accountService, IWebAnalyticsProviderService webAnalyticsProviderService, IPushNotificationService pushNotificationService)
        {
        ...
        public HttpResponseMessage PushNotificationDetails(PushNotification ViewModel)
        {
            ...
            try
            {
               response = pushNotificationService.PushNotification(new PushNotificationRequest() { PushNotification = ViewModel });
            }
            catch(Exception ex)
            {
