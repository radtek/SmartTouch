var apiViewModel = function (data) {
    ...
    selfAPI.ExposedMethods = [
        ...
        { Key: "POSTPerson", DisplayName: "Insert Person", View: "InsertPerson", SortID: 4 },  //Key: "POSTPerson" is defined based on the RequestType + Route
        { Key: "POSTAddAction", DisplayName: "Add Action", View: "AddAction", SortID: 5 },
        { Key: "POSTTours", DisplayName: "Add Tour", View: "AddTour", SortID: 6 },
        { Key: "POSTNote/InsertNote", DisplayName: "Add Note", View: "AddNote", SortID: 7 }
    ]
    ...
    selfAPI.ExcludedActionProperties = [
        {
            MethodName: "POSTAddAction", Properties: [
             "ActionId",
             "AccountId",
             "ReminderTypes",
             "ReminderMethods",
    ...
    selfAPI.ExcludedTourProperties = [
        {
            MethodName: "POSTTours", Properties: [
                "TourID",
                "AccountId",
                "Community",
                "LastUpdatedBy",
    ...
    selfAPI.ExcludedNoteProperties = [
        {
            MethodName: "POSTNote/InsertNote", Properties: [
                "NoteId",
                "AccountId",
                "OppurtunityId",
                "CreatedBy",
