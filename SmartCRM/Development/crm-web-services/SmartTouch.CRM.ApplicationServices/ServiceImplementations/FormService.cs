...
namespace SmartTouch.CRM.ApplicationServices.ServiceImplementations
{
    public class FormService : IFormService
    {
        ...
        readonly ISearchService<Contact> contactSearchService;
        ...
        public FormService(IFormRepository formRepository,
            ...
            , ILeadScoreRuleRepository leadScoreRuleRepository
        ...
        PersonViewModel convertToPersonViewModel(SubmittedFormViewModel viewModel, IEnumerable<DropdownViewModel> dropdownValues)
        {
            ...
            var firstNameField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.FirstNameField).ToString());
            personViewModel.FirstName = firstNameField != null ? firstNameField.Value : null;
            var lastNameField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.LastNameField).ToString());
            personViewModel.LastName = lastNameField != null ? lastNameField.Value : null;
            Logger.Current.Verbose("First Name, Last Name ");

            var companyField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.CompanyNameField).ToString());
            personViewModel.CompanyName = companyField != null ? companyField.Value : null;

            var title = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.TitleField).ToString());
            personViewModel.Title = title != null ? title.Value : null;

            var emailField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.PrimaryEmail).ToString());
            ...
            var mobilePhoneField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.MobilePhoneField).ToString());
            var homePhoneField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.HomePhoneField).ToString());
            var workPhoneField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.WorkPhoneField).ToString());
            ...
            var facebookUrl = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.FacebookUrl).ToString());
            var twitterUrl = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.TwitterUrl).ToString());
            var linkedInUrl = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.LinkedInUrl).ToString());
            var googlePlusUrl = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.GooglePlusUrl).ToString());
            var websiteUrl = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.WebsiteUrl).ToString());
            var blogUrl = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.BlogUrl).ToString());
            ...
            var addressLine1 = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.AddressLine1Field).ToString());
            var addressLine2 = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.AddressLine2Field).ToString());
            var city = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.CityField).ToString());
            var state = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.StateField).ToString());
            var country = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.CountryField).ToString());
            ...
            var defaultLifeCycleType = personViewModel.LifecycleStages.FirstOrDefault(a => a.IsDefault);
        ...
        PersonViewModel ManagePersonSocialProfiles(PersonViewModel viewModel)
        {
            ...
            if (fullContact != null && fullContact.socialProfiles != null && fullContact.socialProfiles.Count > 0)
            {
                ...
                var googleUrl = fullContact.socialProfiles.FirstOrDefault(p => p.typeId == "googleplus");

                if (facebookUrl != null && !string.IsNullOrEmpty(facebookUrl.url))
                    if (updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "Facebook") != null)
                        updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "Facebook").URL = facebookUrl.url;
                    else
                ...
                if (twitterUrl != null && !string.IsNullOrEmpty(twitterUrl.url))
                    if (updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "Twitter") != null)
                        updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "Twitter").URL = twitterUrl.url;
                    else
                ...
                if (linkedinUrl != null && !string.IsNullOrEmpty(linkedinUrl.url))
                    if (updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "LinkedIn") != null)
                        updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "LinkedIn").URL = linkedinUrl.url;
                    else
                ...
                if (googleUrl != null && !string.IsNullOrEmpty(googleUrl.url))
                    if (updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "Google+") != null)
                        updatedModel.SocialMediaUrls.FirstOrDefault(p => p.MediaType == "Google+").URL = googleUrl.url;
                    else
        ...
        PersonViewModel updatePersonViewModel(PersonViewModel personViewModel, SubmittedFormViewModel viewModel, IEnumerable<Url> socialUrls)
        {
            ...
            var titleField = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.TitleField).ToString());
            ...
            var city = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.CityField).ToString());
            var state = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.StateField).ToString());
            var zip = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.ZipCodeField).ToString());
            var country = viewModel.SubmittedFormFields.FirstOrDefault(f => f.Key == ((byte)Entities.ContactFields.CountryField).ToString());
            ...
            if (addressLine1 != null || addressLine2 != null || city != null || zip != null || country != null || state != null)
            {
                ...
                AddressViewModel newAddress = new AddressViewModel();
                newAddress.AddressTypeID = personViewModel.AddressTypes.FirstOrDefault(a => a.IsDefault).DropdownValueID;
                newAddress.AddressLine1 = addressLine1 != null && !string.IsNullOrEmpty(addressLine1.Value) ? addressLine1.Value : "";
                newAddress.AddressLine2 = addressLine2 != null && !string.IsNullOrEmpty(addressLine2.Value) ? addressLine2.Value : "";
                newAddress.City = city != null && !string.IsNullOrEmpty(city.Value) ? city.Value : "";
                if (state != null)
        ...
        public GetApproveLeadsResponse GetLeadsApproveQueue(GetApproveLeadsRequest request)
        {
            GetApproveLeadsResponse response = new GetApproveLeadsResponse();
            response.Queue = formRepository.GetLeadsQueue(request.AccountId, request.PageNumber, request.Limit, (short)request.DateType);
            return response;
        }

        public UpdateFailedFromLeadsResponse UpdateFailedForm(UpdateFailedFormLeadsRequest request)
        {
            UpdateFailedFromLeadsResponse response = new UpdateFailedFromLeadsResponse();
            if (request.Queue.LeadSourceType == "Forms")
                formRepository.UpdateFormData(request.Queue, request.RequestedBy.Value);
            else if (request.Queue.LeadSourceType == "API")
            {
                string submittedData = formRepository.GetAPIJson(request.Queue.SubmittedFormDataID);
                if (!string.IsNullOrEmpty(submittedData) && request.Queue != null)
                {
                    ApproveLeadsQueue queue = request.Queue;
                    PersonViewModel model = JsonConvert.DeserializeObject<PersonViewModel>(submittedData);
                    model.FirstName = queue.FirstName;
                    model.LastName = queue.LastName;
                    IList<Email> emails = model.Emails;
                    if (emails.IsAny())
                        foreach (var email in emails.Where(w => w.IsPrimary))
                            email.EmailId = queue.Email;
                    string json = JsonConvert.SerializeObject(model);
                    formRepository.UpdateAPIData(json, request.RequestedBy.Value, request.Queue.SubmittedFormDataID);
                }
            }
            return response;
        }

        public void FailedFormsSummaryEmail()
        {
            List<int> accountIDs = formRepository.GetActiveAcountIds();

            foreach (int Id in accountIDs)
            {
                List<UserSummary> userSummary = formRepository.GetUserDetails(Id);
                if (userSummary.Count > 0)
                {
                    string body = GetFailedFormEmailBody(Id);
                    Account account = accountService.GetAccountMinDetails(Id);
                    Guid loginToken = new Guid();
                    IEnumerable<ServiceProvider> serviceProviders = serviceProviderRepository.GetAccountCommunicationProviders(Id, CommunicationType.Mail, MailType.TransactionalEmail);
                    ...
                    foreach (var summary in userSummary)
                    {
                        ...
                        mailRequest.From = account.Email.EmailId;
                        mailRequest.IsBodyHtml = true;
                        mailRequest.ScheduledTime = DateTime.UtcNow.AddMinutes(2);
                        mailRequest.Subject = "Suspect Submissions Waiting on Approval";
                        mailRequest.To = new List<string>() { summary.UserEmail };
                        mailRequest.TokenGuid = loginToken;
                        mailRequest.RequestGuid = Guid.NewGuid();
                        mailRequest.AccountDomain = account.DomainURL;
                        mailRequest.CategoryID = (short)EmailNotificationsCategory.FailedFormsReport;
                        mailRequest.AccountID = Id;
        ...
        public string GetFailedFormEmailBody(int accountId)
        {
            string body = "";
            string filename = EmailTemplate.FailedFormsTemplate.ToString() + ".txt";
            ...
            IEnumerable<ApproveLeadsQueue> contactsSummary = formRepository.GetLeadsQueue(accountId, 1, 100, 3);

            if (contactsSummary.IsAny())
            {
                contactsSummary.ToList().ForEach(c =>
                {
                    contacts.Add("<tr><td style='margin:0px;padding:10px;font-size:12px; font-weight:normal;color:#555555;font-family:arial,sans-serif;border-bottom:solid 1px #d9d9d9;'>" + c.LeadSourceType + "</td>" +
                        "<td style='margin:0px;padding:10px;font-size:12px; font-weight:normal;color:#555555;font-family:arial,sans-serif;border-bottom:solid 1px #d9d9d9;'>" + c.FirstName + "</td>" +
                        "<td style='margin:0px;padding:10px;font-size:12px; font-weight:normal;color:#555555;font-family:arial,sans-serif;border-bottom:solid 1px #d9d9d9;'>" + c.LastName + "</td>" +
                        "<td style='margin:0px;padding:10px;font-size:12px; font-weight:normal;color:#555555;font-family:arial,sans-serif;border-bottom:solid 1px #d9d9d9;'>" + c.Email + "</td>" +
                        "<td style='margin:0px;padding:10px;font-size:12px; font-weight:normal;color:#555555;font-family:arial,sans-serif;border-bottom:solid 1px #d9d9d9;'>" + c.Remarks + "</td>" + "</tr>");
                });
            }
            else
                contacts = new List<string>() { "No failed Form/API Submissions" };
            string contactsBody = string.Join("", contacts);

            using (StreamReader reader = new StreamReader(savedFileName))
            {
                do
                {
                    body = reader.ReadToEnd().Replace("[CONTACTS]", contactsBody)
        ...
        public GetFailedFormsResultsResponse GetFailedFormsResults(GetFailedFormsResultsRequest request)
        {
            GetFailedFormsResultsResponse response = new GetFailedFormsResultsResponse();
            DataTable table = new DataTable();
            table.Columns.Add("Source Type");
            ...
            foreach (ApproveLeadsQueue q in request.Queue)
            {
                for (int i = 0; i < 5; i++)
                {
                    if (i == 0)
                        values[i] = q.LeadSourceType;
                    else if (i == 1)
                        values[i] = q.FirstName;
                    else if (i == 2)
                        values[i] = q.LastName;
                    else if (i == 3)
                        values[i] = q.Email;
            ...
            byte[] array = exl.ConvertDataSetToExcel(table, "");
