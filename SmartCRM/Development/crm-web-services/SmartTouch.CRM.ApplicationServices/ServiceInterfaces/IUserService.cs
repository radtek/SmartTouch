...
namespace SmartTouch.CRM.ApplicationServices.ServiceInterfaces
{
    public interface IUserService
    {
        ...
        GetUsersByUserIDsResponse GetUserBasicInfo(GetUsersByUserIDsRequest request);
        ...
        MyCommunicationResponse GetMyCommunicationDetails(MyCommunicationRequest request);
        GetMyCommunicationContactsResponse GetMyCommunicationContacts(GetMyCommunicationContactsRequest request);
        GetUserResponse GetUserDetailsByEmailAndAccountId(GetUserRequest request);
    }
}
