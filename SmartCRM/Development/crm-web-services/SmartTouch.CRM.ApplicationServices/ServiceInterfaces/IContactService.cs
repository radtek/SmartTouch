...
namespace SmartTouch.CRM.ApplicationServices.ServiceInterfaces
{
    public interface IContactService
    {
        ...
        GetUntouchedContactsResponse GetUntouchedContactsIds(GetUntouchedContactsRequest request);
        BulkoperationConactsInsertionResponse InsertBulkOperationConacts(BulkoperationConactsInsertionRequest request);
    }
}
